          ...
          {!isSidebarCollapsed && (
            <div className="flex items-center gap-2.5 px-3 py-2 bg-sidebar-accent/40 rounded-xl border border-sidebar-border/20 mb-1">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-sidebar-foreground text-xs truncate">{user?.full_name || user?.name || 'Admin'}</p>
                <p className="text-[9px] text-sidebar-foreground/50 font-bold uppercase tracking-widest">{user?.role || 'admin'}</p>
              </div>
